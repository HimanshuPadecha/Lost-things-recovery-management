...
const mockItems: Item[] = [
  {
    ...
    date: "2024-01-20",
    image: null,
    description: "Black leather wallet with blue stripe, contains personal cards.",
  },
  {
    id: 2,
    type: "found",
  ...
  },
  {
    ...
    date: "2024-01-18",
    image: null,
    description: "Missing golden retriever, very friendly, wearing blue collar.",
  },
  {
    id: 4,
    type: "found",
  ...
  },
  {
    ...
    date: "2024-01-16",
    image: null,
    description: "Lost Indian passport and some important documents near check-in.",
  },
  {
    id: 6,
    type: "found",
    ...
    <div className="max-w-7xl mx-auto px-4">
      ...
      >
        ...
        <p className="text-muted-foreground max-w-lg mx-auto">
          Browse through reported items or use filters to find what you're looking for
        </p>
      </motion.div>
